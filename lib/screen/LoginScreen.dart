 ...
 bool checkboxvalue=false;
  ...
  //-sign Up for Form------------------------
    ...
    else
    {
       ...
       SignUpToDataBase(signUPUserEmail,signUPName,signUPpassword,signUPphoneNumber);
       }else{
         showDialog<String>(
   ...
   content: Text("confirm your password !!",textAlign: TextAlign.center, style: TextStyle(color: ColorForDesign().black, )),
   actions: <Widget>[
         
            Center(
              child: TextButton(
                onPressed: () => Navigator.pop(context, 'OK'),
                child:  Text('OK' , style: TextStyle(color: ColorForDesign().black, )),
              ),
            ),
          ],
   );
...
showDialog<String>(
       ...
       return AlertDialog(
         ...
         backgroundColor: ColorForDesign().Gold,
   content: Text('this account is already exist',style: TextStyle(color: ColorForDesign().black, )),
   actions: <Widget>[
        ...
        //     TextButton(
        //       onPressed: () => Navigator.pop(context, 'OK'),
        //       child:  Text('OK' , style: TextStyle(color: ColorForDesign().Gold, )),
        //     ),
        //   ],
        // ),
      );
...
showDialog<String>(
       ...
       return AlertDialog(
         ...
         backgroundColor: ColorForDesign().Gold,
   content: Text("We can't find this account. Please try another active account",textAlign: TextAlign.center, style: TextStyle(color: ColorForDesign().black, )),
   actions: <Widget>[
          ...
          child: Column(
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        decoration: InputDecoration(
                                          prefixIcon: Icon(Icons.email,color: ColorForDesign().Gold,),
            ...
            icon: Icon(
              ...
              color: ColorForDesign().Gold,
                                            ...
                                            prefixIcon: Icon(Icons.lock,color: ColorForDesign().Gold,),
                                    ...
                                    Row(
                                      children: [
                                        Theme(
                                            data: ThemeData(unselectedWidgetColor: ColorForDesign().Gold,),
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          keyboardType:
                                              TextInputType.emailAddress,
                                          decoration: InputDecoration(
                                            prefixIcon: Icon(Icons.account_box,color: ColorForDesign().Gold,),
                                            labelText: 'Name',
                                            labelStyle: TextStyle(
                                                color: ColorForDesign().Gold),
                                            focusedErrorBorder:
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          keyboardType:
                                              TextInputType.emailAddress,
                                          decoration: InputDecoration(
                                            prefixIcon: Icon(Icons.phone,color: ColorForDesign().Gold,),
            ...
            icon: Icon(
              _passwordsignupVisible ? Icons.visibility_sharp : Icons.visibility_off,
              color: ColorForDesign().Gold,
            ),
          ),
                                            prefixIcon: Icon(Icons.lock,color: ColorForDesign().Gold,),
            ...
            onPressed: () {
              setState(() {
                _passwordsignupconfermVisible = !_passwordsignupconfermVisible;
              });
            },
            icon: Icon(
              _passwordsignupconfermVisible ? Icons.visibility_sharp : Icons.visibility_off,
              color: ColorForDesign().Gold,
            ),
          ),
                                            prefixIcon: Icon(Icons.lock_clock_sharp,color: ColorForDesign().Gold,),
